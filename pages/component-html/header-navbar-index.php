...
<div class="header d-flex align-items-center p-2">
    <div class="header-content text-lg-center col-lg-10 col-md-10 d-md-block d-none">Free shipping on orders above 200$ (US only)</div>
    
    <!--User-->
    <div class="header-content col-md-1 col-6 me-md-2 me-lg-0">
        <a id="user" class="text-decoration-none header-content" href="#"></a>
    </div> 
    ...
    <div class="navigation nav navbar navbar-expand-lg p-0 navbar-dark">
        ...
        <div class="container-fluid">
            ...
            <a class="navbar-brand nav-img" href="#">
                <img src="./images/component-img/nav-img.png" height="100%" width="100%" alt="">
            </a>
            ...
            <a class="navbar-brand nav-icons d-flex justify-content-around me-0 d-lg-none d-flex">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" viewBox="0 0 20 25" fill="none" data-bs-toggle="collapse" data-bs-target="#cart-fields">
