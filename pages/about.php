...
<body class="bg-light body-theme-fw">
    ...
    <div class="bg-black row p-5 m-0">
        ...
        <div class="bg-black col-lg-7 align-self-lg-center order-lg-1 order-sm-0  order-0">
            <img src="../images/about-img/about-us-img.png" alt="about-us-img" class="img-fluid float-end">
        </div>
    ...
    <div class="bg-black row p-5 m-0">
        ...
        <div class="col-lg-2 order-sm-0 order-md-1  order-lg-1 order-0 order-sm-0">
            <img src="../images/about-img/about-helping-hands.png" alt="helping-hands">
        </div>
    </div>
    ...
    <div class="bg-black row p-5 m-0">
        ...
        <div class="row ">
            <div class="col-lg-4 col-md-6 pb-4">
                <div class="row">
                    <div class="d-flex align-items-center justify-content-center pb-3">
                        <img src="../images/about-img/about-charities_1.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 pb-4">
                <div class="row">
                    <div class="d-flex align-items-center justify-content-center pb-3">
                        <img src="../images/about-img/about-charities_2.png" alt="" class="align-content-center">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 pb-4">
                <div class="row">
                    <div class="d-flex align-items-center justify-content-center pb-3">
                        <img src="../images/about-img/about-charities_3.png" alt="" class="align-content-center">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 pb-4">
                <div class="row">
                    <div class="d-flex align-items-center justify-content-center pb-3">
                        <img src="../images/about-img/about-charities_4.png" alt="" class="align-content-center">
                    </div>
